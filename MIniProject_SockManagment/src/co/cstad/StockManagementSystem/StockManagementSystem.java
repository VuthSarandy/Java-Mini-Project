package co.cstad.StockManagementSystem;
...
public class StockManagementSystem {
    ...
    public StockManagementSystem(Integer id, String name, Integer unitPrice, Integer qty, LocalDate date) {
        this.id = id;
        this.name = name;
        this.unitPrice = unitPrice;
        this.Qty = qty;
    ...
    public boolean equals(Object o) {
        ...
        StockManagementSystem that = (StockManagementSystem) o;
